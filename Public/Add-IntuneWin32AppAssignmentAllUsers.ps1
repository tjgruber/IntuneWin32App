function Add-IntuneWin32AppAssignmentAllUsers {
    <#
    .SYNOPSIS
        Add an 'All Users' assignment to a Win32 app.
    ...
    Process {
        ...
        if ($Win32App -ne $null) {
            ...
            $DuplicateAssignment = Test-IntuneWin32AppAssignment -ID $Win32AppID -Target "AllUsers"
